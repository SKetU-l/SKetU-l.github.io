...
const MainContent = () => (
  <main className={`${poppins.className} text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight flex flex-col space-y-2 select-none w-full`}>
